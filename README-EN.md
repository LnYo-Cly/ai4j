...
- **Complete RAG built in**: document loading (optional Tika for PDF/Word/Excel, or MinerU cloud parsing of scans/formulas/complex layouts into Markdown), chunking, eight vector-store adapters (Pinecone / Qdrant / pgvector / Milvus / Redis / Elasticsearch / Chroma / InMemory), hybrid retrieval, reranking, and citations — the whole pipeline is implemented inside the SDK, no external retrieval stack needed.
