...
- **Complete RAG built in**: document loading (optional Tika for PDF/Word/Excel, or MinerU cloud parsing of scans/formulas/complex layouts into Markdown), chunking, five vector-store adapters (Pinecone / Qdrant / pgvector / Milvus / Redis), hybrid retrieval, reranking, and citations — the whole pipeline is implemented inside the SDK, no external retrieval stack needed.
...
- Gradle: `implementation 'io.github.lnyo-cly:ai4j:2.7.0'`
- Maven: `<dependency><groupId>io.github.lnyo-cly</groupId><artifactId>ai4j</artifactId><version>2.7.0</version></dependency>`
