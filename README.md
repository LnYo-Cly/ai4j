...
- **独创 `ai4j-harness` 长时运行 Harness**：让 Agent 从"一次性调用"变成"可运维的长期任务"——任务可暂停、可恢复、可审批验收，多实例部署时安全认领不重复执行，全程留痕可审计。
...
- **官方文档站**：https://lnyo-cly.github.io/ai4j/ —— 中英双语，从 5 分钟跑通到各能力详解，附 50+ 张源码对齐的架构/时序图，适合系统学习和查 API 用法
