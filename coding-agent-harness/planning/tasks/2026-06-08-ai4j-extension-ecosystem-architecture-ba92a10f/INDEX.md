# AI4J extension ecosystem architecture - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-08-ai4j-extension-ecosystem-architecture-ba92a10f` |
| Budget | `complex` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'AI4J extension ecosystem architecture' . |
| Budget | complex |
