# ai4j app builder user skill - 教训候选
...
| Closeout token | checked-none:task-local-skill-boundary-only |
| Source task | 2026-06-05-ai4j-app-builder-user-skill-c784073b |
| Owner | coordinator |
...
本任务只新增一次性的用户侧 Skill 和 README 安装入口。维护 Skill 与用户应用 Skill 分离是本任务内的产品边界决策，已记录在 walkthrough；目前没有形成需要沉淀到全局治理标准的可复用 lesson。
