# ai4j app builder user skill - 任务包索引
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'ai4j app builder user skill' --preset standard-task '<target>' |
| Budget | standard |
