...
| --- | --- | --- | --- | ---: | --- | --- | --- | --- | --- | --- | --- |
| INIT-01 | init | none | planned | 0 | 任务边界已清楚到可以执行 | `task_plan.md` | `harness task-start 2026-07-05-rag-query-planner-strategy-prompts-ddd48298` | agent | missing | none | coordinator |
