...
| EXEC-01 | execution | INIT-01 | done | 100 | planner 实现、测试、docs 和回归记录已完成 | diff、command、progress evidence | `harness task-phase 2026-07-05-rag-query-planner-strategy-prompts-ddd48298 EXEC-01 --state done --completion 100 --evidence present` | agent | present | none | coordinator |
| GATE-01 | gate | EXEC-01 | planned | 0 | 提交、PR、清理前最终确认 | progress update 和最终证据说明 | `harness task-complete 2026-07-05-rag-query-planner-strategy-prompts-ddd48298 --message "<summary>"` | agent | present | none | coordinator |
