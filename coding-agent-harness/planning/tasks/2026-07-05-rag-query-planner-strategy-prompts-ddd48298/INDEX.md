# rag query planner strategy prompts - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-05-rag-query-planner-strategy-prompts-ddd48298` |
| Budget | `simple` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget simple --locale zh-CN --title 'rag query planner strategy prompts' . |
| Budget | simple |
