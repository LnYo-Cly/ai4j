# AI4J extension plugin scaffold wave 9 - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-09-ai4j-extension-plugin-scaffold-wave-9-1923fbfb` |
| Budget | `complex` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'AI4J extension plugin scaffold wave 9' . |
| Budget | complex |
...
| Confirm Text | 2026-06-09-ai4j-extension-plugin-scaffold-wave-9-1923fbfb |
