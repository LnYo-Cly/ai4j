# live provider test hygiene - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-04-live-provider-test-hygiene-c392a468` |
| Budget | `complex` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'live provider test hygiene' --preset standard-task '<target>' |
| Budget | complex |
...
| Confirmation ID | HRC-202606041121 |
| Confirmed At | 2026-06-04 11:21 |
