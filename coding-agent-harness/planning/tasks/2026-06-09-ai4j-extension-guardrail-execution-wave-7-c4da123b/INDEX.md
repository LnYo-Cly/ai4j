# AI4J extension guardrail execution wave 7 - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-09-ai4j-extension-guardrail-execution-wave-7-c4da123b` |
| Budget | `complex` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'AI4J extension guardrail execution wave 7' . |
| Budget | complex |
...
| Confirm Text | 2026-06-09-ai4j-extension-guardrail-execution-wave-7-c4da123b |
