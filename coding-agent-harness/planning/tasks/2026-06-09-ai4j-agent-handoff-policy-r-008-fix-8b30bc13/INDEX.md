# AI4J agent handoff policy R-008 fix - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-09-ai4j-agent-handoff-policy-r-008-fix-8b30bc13` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AI4J agent handoff policy R-008 fix' . |
| Budget | standard |
...
| Confirm Text | 2026-06-09-ai4j-agent-handoff-policy-r-008-fix-8b30bc13 |
