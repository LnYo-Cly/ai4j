# core sdk invocation contract audit - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-07-core-sdk-invocation-contract-audit-8ef9d763` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'core sdk invocation contract audit' . |
| Budget | standard |
...
| Confirm Text | 2026-06-07-core-sdk-invocation-contract-audit-8ef9d763 |
