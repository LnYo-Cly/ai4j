# AI4J Extension Permission and Install UX - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-10-ai4j-extension-permission-and-install-ux-95f89265` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AI4J Extension Permission and Install UX' . |
| Budget | standard |
...
| Confirm Text | 2026-06-10-ai4j-extension-permission-and-install-ux-95f89265 |
