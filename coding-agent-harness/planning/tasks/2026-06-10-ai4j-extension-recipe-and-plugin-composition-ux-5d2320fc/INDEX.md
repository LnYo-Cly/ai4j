# AI4J Extension Recipe and Plugin Composition UX - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-10-ai4j-extension-recipe-and-plugin-composition-ux-5d2320fc` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AI4J Extension Recipe and Plugin Composition UX' . |
| Budget | standard |
...
| Confirmation ID | HRC-202606101633 |
| Confirmed At | 2026-06-10 16:33 |
