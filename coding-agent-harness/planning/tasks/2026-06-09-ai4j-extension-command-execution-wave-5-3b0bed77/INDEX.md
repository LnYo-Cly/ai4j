# AI4J extension command execution wave 5 - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-09-ai4j-extension-command-execution-wave-5-3b0bed77` |
| Budget | `complex` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'AI4J extension command execution wave 5' . |
| Budget | complex |
...
| Confirm Text | 2026-06-09-ai4j-extension-command-execution-wave-5-3b0bed77 |
