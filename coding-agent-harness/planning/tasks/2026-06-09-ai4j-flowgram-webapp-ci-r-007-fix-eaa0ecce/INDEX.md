# AI4J FlowGram webapp CI R-007 fix - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-09-ai4j-flowgram-webapp-ci-r-007-fix-eaa0ecce` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AI4J FlowGram webapp CI R-007 fix' . |
| Budget | standard |
...
| Confirm Text | 2026-06-09-ai4j-flowgram-webapp-ci-r-007-fix-eaa0ecce |
