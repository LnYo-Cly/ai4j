# docs site information architecture redesign - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-04-docs-site-information-architecture-redesign-6c91ba27` |
| Budget | `complex` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'docs site information architecture redesign' --preset standard-task '<target>' |
| Budget | complex |
...
| Confirmation ID | HRC-202606041204 |
| Confirmed At | 2026-06-04 12:04 |
