# AI4J docs site Node heap regression R-005 fix - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-09-ai4j-docs-site-node-heap-regression-r-005-fix-08b5fbcb` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AI4J docs site Node heap regression R-005 fix' . |
| Budget | standard |
...
| Confirm Text | 2026-06-09-ai4j-docs-site-node-heap-regression-r-005-fix-08b5fbcb |
