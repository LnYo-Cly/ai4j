# regression baseline live split - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-04-regression-baseline-live-split-b2f834db` |
| Budget | `complex` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'regression baseline live split' --preset standard-task '<target>' |
| Budget | complex |
...
| Confirmation ID | HRC-202606041042 |
| Confirmed At | 2026-06-04 10:42 |
