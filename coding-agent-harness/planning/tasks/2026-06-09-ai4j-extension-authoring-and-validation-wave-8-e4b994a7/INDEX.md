# AI4J extension authoring and validation wave 8 - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-09-ai4j-extension-authoring-and-validation-wave-8-e4b994a7` |
| Budget | `complex` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'AI4J extension authoring and validation wave 8' . |
| Budget | complex |
...
| Confirm Text | 2026-06-09-ai4j-extension-authoring-and-validation-wave-8-e4b994a7 |
