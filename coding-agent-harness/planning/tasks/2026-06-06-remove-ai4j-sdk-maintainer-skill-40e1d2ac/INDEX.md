# remove ai4j sdk maintainer skill - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-06-remove-ai4j-sdk-maintainer-skill-40e1d2ac` |
| Budget | `standard` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'remove ai4j sdk maintainer skill' --preset standard-task '<target>' |
| Budget | standard |
...
| Confirmation ID | HRC-202606060622 |
| Confirmed At | 2026-06-06 06:22 |
