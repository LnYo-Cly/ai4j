# Feature SSoT closeout drift cleanup - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-07-feature-ssot-closeout-drift-cleanup-a8e25ef6` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'Feature SSoT closeout drift cleanup' . |
| Budget | standard |
...
| Confirm Text | 2026-06-07-feature-ssot-closeout-drift-cleanup-a8e25ef6 |
