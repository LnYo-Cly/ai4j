# ai4j dynamic workflow plugin - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-06-ai4j-dynamic-workflow-plugin-d652ef2e` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'ai4j dynamic workflow plugin' . |
| Budget | standard |
