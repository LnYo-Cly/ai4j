# Feature SSoT review queue status alignment - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-10-feature-ssot-review-queue-status-alignment-4c6620f5` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'Feature SSoT review queue status alignment' . |
| Budget | standard |
...
| Confirm Text | 2026-06-10-feature-ssot-review-queue-status-alignment-4c6620f5 |
