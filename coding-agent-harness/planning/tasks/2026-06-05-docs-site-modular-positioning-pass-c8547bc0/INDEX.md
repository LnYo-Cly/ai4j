# docs site modular positioning pass - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-05-docs-site-modular-positioning-pass-c8547bc0` |
| Budget | `complex` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'docs site modular positioning pass' --preset standard-task '<target>' |
| Budget | complex |
...
| Confirmation ID | HRC-202606050324 |
| Confirmed At | 2026-06-05 03:24 |
