# AI4J extension skill prompt resources wave 6 - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-09-ai4j-extension-skill-prompt-resources-wave-6-3c37dd11` |
| Budget | `complex` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'AI4J extension skill prompt resources wave 6' . |
| Budget | complex |
...
| Confirm Text | 2026-06-09-ai4j-extension-skill-prompt-resources-wave-6-3c37dd11 |
