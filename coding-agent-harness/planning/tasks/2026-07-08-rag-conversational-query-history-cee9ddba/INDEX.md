# rag conversational query history - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-08-rag-conversational-query-history-cee9ddba` |
| Budget | `simple` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget simple --locale zh-CN --title 'rag conversational query history' . |
| Budget | simple |
