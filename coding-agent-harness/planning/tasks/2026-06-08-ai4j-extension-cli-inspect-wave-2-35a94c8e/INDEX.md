# AI4J extension CLI inspect wave 2 - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-08-ai4j-extension-cli-inspect-wave-2-35a94c8e` |
| Budget | `complex` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'AI4J extension CLI inspect wave 2' . |
| Budget | complex |
...
| Confirm Text | 2026-06-08-ai4j-extension-cli-inspect-wave-2-35a94c8e |
