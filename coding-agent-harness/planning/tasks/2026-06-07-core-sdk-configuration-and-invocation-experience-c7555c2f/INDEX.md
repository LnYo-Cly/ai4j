# Core SDK configuration and invocation experience upgrade design - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-07-core-sdk-configuration-and-invocation-experience-c7555c2f` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'Core SDK configuration and invocation experience upgrade design' . |
| Budget | standard |
...
| Confirm Text | 2026-06-07-core-sdk-configuration-and-invocation-experience-c7555c2f |
