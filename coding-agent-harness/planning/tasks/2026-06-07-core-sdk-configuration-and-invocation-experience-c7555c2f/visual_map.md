...
| GATE-01 | gate | EXEC-01 | done | 100 | Agent Review Submission | `review.md`、progress update、lesson routing | `harness task-review 2026-06-07-core-sdk-configuration-and-invocation-experience-c7555c2f --message "<summary>"` | agent | present | none | coordinator |
