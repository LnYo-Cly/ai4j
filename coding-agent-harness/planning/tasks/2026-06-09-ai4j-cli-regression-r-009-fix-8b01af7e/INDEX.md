# AI4J CLI Regression R-009 Fix - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-09-ai4j-cli-regression-r-009-fix-8b01af7e` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AI4J CLI Regression R-009 Fix' . |
| Budget | standard |
...
| Confirm Text | 2026-06-09-ai4j-cli-regression-r-009-fix-8b01af7e |
