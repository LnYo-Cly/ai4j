# AI4J Spring Boot extension configuration wave 4 - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-09-ai4j-spring-boot-extension-configuration-wave-4-cb1cd3f6` |
| Budget | `complex` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'AI4J Spring Boot extension configuration wave 4' . |
| Budget | complex |
...
| Confirm Text | 2026-06-09-ai4j-spring-boot-extension-configuration-wave-4-cb1cd3f6 |
