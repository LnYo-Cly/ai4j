# RAG token aware encoding fallback - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-07-rag-token-aware-encoding-fallback-c8fc6d32` |
| Budget | `simple` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget simple --locale zh-CN --title 'RAG token aware encoding fallback' . |
| Budget | simple |
