...
| --- | --- | --- | --- | ---: | --- | --- | --- | --- | --- | --- | --- |
| INIT-01 | init | none | planned | 0 | 任务边界已清楚到可以执行 | `task_plan.md` | `harness task-start 2026-07-05-hybrid-retriever-best-effort-fallback-aa6b302b` | agent | missing | none | coordinator |
