# hybrid retriever best effort fallback - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-05-hybrid-retriever-best-effort-fallback-aa6b302b` |
| Budget | `simple` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget simple --locale zh-CN --title 'hybrid retriever best effort fallback' . |
| Budget | simple |
