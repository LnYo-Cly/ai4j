# AI4J extension runtime adapter wave 3 - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-09-ai4j-extension-runtime-adapter-wave-3-e94c61c5` |
| Budget | `complex` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'AI4J extension runtime adapter wave 3' . |
| Budget | complex |
...
| Confirm Text | 2026-06-09-ai4j-extension-runtime-adapter-wave-3-e94c61c5 |
