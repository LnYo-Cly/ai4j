# rag online evaluation llm judge - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-06-rag-online-evaluation-llm-judge-4fe59b6d` |
| Budget | `simple` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget simple --locale zh-CN --title 'rag online evaluation llm judge' . |
| Budget | simple |
