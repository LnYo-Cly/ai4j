...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-06-ai4j-dynamic-workflow-host-runtime-ef15599f` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `yes` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'ai4j dynamic workflow host runtime' --long-running '<target>' |
| Budget | standard |
