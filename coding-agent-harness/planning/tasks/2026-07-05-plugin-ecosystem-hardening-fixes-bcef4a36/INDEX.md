# plugin ecosystem hardening fixes - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-05-plugin-ecosystem-hardening-fixes-bcef4a36` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'plugin ecosystem hardening fixes' . |
| Budget | standard |
