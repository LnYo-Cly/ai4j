# agent trace streaming error structure - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-06-agent-trace-streaming-error-structure-16d40045` |
| Budget | `simple` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget simple --locale zh-CN --title 'agent trace streaming error structure' . |
| Budget | simple |
