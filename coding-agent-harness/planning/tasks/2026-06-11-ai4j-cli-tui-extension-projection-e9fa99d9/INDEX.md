# AI4J CLI TUI extension projection - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-11-ai4j-cli-tui-extension-projection-e9fa99d9` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AI4J CLI TUI extension projection' . |
| Budget | standard |
