# AI4J Extension Check Gate - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-11-ai4j-extension-check-gate-d3f91b18` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AI4J Extension Check Gate' . |
| Budget | standard |
...
| Confirmation ID | HRC-202606110930 |
| Confirmed At | 2026-06-11 09:30 |
