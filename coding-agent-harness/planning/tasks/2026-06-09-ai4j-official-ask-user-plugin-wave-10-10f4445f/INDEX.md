# AI4J official ask-user plugin wave 10 - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-09-ai4j-official-ask-user-plugin-wave-10-10f4445f` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AI4J official ask-user plugin wave 10' . |
| Budget | standard |
...
| Confirm Text | 2026-06-09-ai4j-official-ask-user-plugin-wave-10-10f4445f |
