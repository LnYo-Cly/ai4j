...
| GATE-01 | gate | EXEC-01 | done | 100 | Agent Review Submission | `review.md`、progress update、lesson routing | `harness task-review 2026-06-04-docs-site-wave-1-entrance-redesign-54198b78 --message "<summary>"` | agent | present | none | coordinator |
