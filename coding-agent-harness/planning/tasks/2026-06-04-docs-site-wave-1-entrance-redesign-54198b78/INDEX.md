# docs site wave 1 entrance redesign - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-04-docs-site-wave-1-entrance-redesign-54198b78` |
| Budget | `complex` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'docs site wave 1 entrance redesign' --preset standard-task '<target>' |
| Budget | complex |
