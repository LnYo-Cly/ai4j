# CubeSandbox live install and coding sandbox routing - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-21-cubesandbox-live-install-and-coding-sandbox-rout-fd63343a` |
| Budget | `complex` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'CubeSandbox live install and coding sandbox routing' . |
| Budget | complex |
