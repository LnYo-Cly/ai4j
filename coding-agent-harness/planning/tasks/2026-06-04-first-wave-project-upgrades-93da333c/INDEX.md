# first wave project upgrades - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-04-first-wave-project-upgrades-93da333c` |
| Budget | `complex` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'first wave project upgrades' --preset standard-task '<target>' |
| Budget | complex |
...
| Confirmation ID | HRC-202606040850 |
| Confirmed At | 2026-06-04 08:50 |
