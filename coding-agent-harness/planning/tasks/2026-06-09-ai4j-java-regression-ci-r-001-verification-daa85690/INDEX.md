# AI4J Java regression CI R-001 verification - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-09-ai4j-java-regression-ci-r-001-verification-daa85690` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AI4J Java regression CI R-001 verification' . |
| Budget | standard |
...
| Confirm Text | 2026-06-09-ai4j-java-regression-ci-r-001-verification-daa85690 |
