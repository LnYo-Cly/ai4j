# AI4J Agent SDK architecture enhancement planning - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-20-ai4j-agent-sdk-architecture-enhancement-planning-b6a2e312` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AI4J Agent SDK architecture enhancement planning' . |
| Budget | standard |
