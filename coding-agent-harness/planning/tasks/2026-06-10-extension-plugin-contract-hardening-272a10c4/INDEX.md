# Extension plugin contract hardening - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-10-extension-plugin-contract-hardening-272a10c4` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'Extension plugin contract hardening' . |
| Budget | standard |
...
| Confirmation ID | HRC-202606100936 |
| Confirmed At | 2026-06-10 09:36 |
