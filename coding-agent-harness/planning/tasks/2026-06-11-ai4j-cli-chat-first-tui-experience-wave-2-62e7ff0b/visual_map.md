...
| --- | --- | --- | --- | ---: | --- | --- | --- | --- | --- | --- | --- |
| INIT-01 | init | none | planned | 0 | 任务计划和执行策略已确认 | `task_plan.md`; `execution_strategy.md` | `harness task-start 2026-06-11-ai4j-cli-chat-first-tui-experience-wave-2-62e7ff0b` | agent | missing | none | coordinator |
