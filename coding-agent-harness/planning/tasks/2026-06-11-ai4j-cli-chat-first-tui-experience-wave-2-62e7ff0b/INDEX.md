# AI4J CLI Chat First TUI Experience Wave 2 - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-11-ai4j-cli-chat-first-tui-experience-wave-2-62e7ff0b` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AI4J CLI Chat First TUI Experience Wave 2' . |
| Budget | standard |
...
| Confirmation ID | HRC-202606140618 |
| Confirmed At | 2026-06-14 06:18 |
