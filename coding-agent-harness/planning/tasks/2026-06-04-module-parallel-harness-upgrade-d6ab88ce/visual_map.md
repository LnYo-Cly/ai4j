...
| GATE-01 | gate | EXEC-01 | done | 100 | Agent Review Submission | `review.md`; `progress.md`; lesson routing | `harness task-review 2026-06-04-module-parallel-harness-upgrade-d6ab88ce --message "<summary>"` | agent | present | none | coordinator |
