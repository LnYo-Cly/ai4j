# rag incremental ingest content hash - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-06-rag-incremental-ingest-content-hash-7112b274` |
| Budget | `simple` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget simple --locale zh-CN --title 'rag incremental ingest content hash' . |
| Budget | simple |
