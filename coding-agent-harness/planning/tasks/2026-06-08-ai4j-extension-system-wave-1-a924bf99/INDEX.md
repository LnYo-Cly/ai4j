# AI4J extension system wave 1 - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-08-ai4j-extension-system-wave-1-a924bf99` |
| Budget | `complex` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'AI4J extension system wave 1' . |
| Budget | complex |
...
| Confirm Text | 2026-06-08-ai4j-extension-system-wave-1-a924bf99 |
