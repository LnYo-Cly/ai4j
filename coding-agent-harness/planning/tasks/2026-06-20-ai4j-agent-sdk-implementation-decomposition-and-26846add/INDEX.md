# AI4J Agent SDK implementation decomposition and docs roadmap - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-20-ai4j-agent-sdk-implementation-decomposition-and-26846add` |
| Budget | `complex` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'AI4J Agent SDK implementation decomposition and docs roadmap' . |
| Budget | complex |
