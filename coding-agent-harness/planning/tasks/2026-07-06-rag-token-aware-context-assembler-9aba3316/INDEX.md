# RAG token-aware context assembler - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-06-rag-token-aware-context-assembler-9aba3316` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'RAG token-aware context assembler' . |
| Budget | standard |
