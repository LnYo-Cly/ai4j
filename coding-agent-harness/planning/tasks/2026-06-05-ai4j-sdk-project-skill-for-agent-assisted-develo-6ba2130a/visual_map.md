...
| GATE-01 | gate | EXEC-01 | done | 100 | Agent Review Submission | `review.md`、progress update、lesson routing | `harness task-review 2026-06-05-ai4j-sdk-project-skill-for-agent-assisted-develo-6ba2130a --message "<summary>"` | agent | present | [risk] | coordinator |
