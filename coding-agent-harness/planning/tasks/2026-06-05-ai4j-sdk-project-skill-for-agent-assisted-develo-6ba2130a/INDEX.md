# ai4j sdk project skill for agent-assisted development - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-05-ai4j-sdk-project-skill-for-agent-assisted-develo-6ba2130a` |
| Budget | `standard` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'ai4j sdk project skill for agent-assisted development' --preset standard-task '<target>' |
| Budget | standard |
