# P3 Coding sandbox tool routing - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-20-p3-coding-sandbox-tool-routing-6c82c346` |
| Budget | `complex` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'P3 Coding sandbox tool routing' --module coding-runtime --preset module '<target>' |
| Budget | complex |
