...
| GATE-01 | gate | VERIFY-01 | done | 100 | Agent Review Submission | `review.md`; final progress evidence; lesson routing | `harness task-review MODULES/coding-runtime/2026-06-20-p3-coding-sandbox-tool-routing-6c82c346 --message "<summary>" .` | agent | present | requires clean tree or lifecycle-owned commit boundary | coordinator |
