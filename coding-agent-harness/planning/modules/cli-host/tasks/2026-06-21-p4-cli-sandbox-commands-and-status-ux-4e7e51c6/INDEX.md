# P4 CLI sandbox commands and status UX - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-21-p4-cli-sandbox-commands-and-status-ux-4e7e51c6` |
| Budget | `complex` |
| Preset | `module` |
| Module | `cli-host` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'P4 CLI sandbox commands and status UX' --module cli-host --preset module '<target>' |
| Budget | complex |
