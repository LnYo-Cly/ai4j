# CLI TUI status context bar - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-21-cli-tui-status-context-bar-e2d583b1` |
| Budget | `standard` |
| Preset | `module` |
| Module | `cli-host` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'CLI TUI status context bar' --module cli-host --preset module '<target>' |
| Budget | standard |
