...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-20-p4-cli-sandbox-commands-72f40aa0` |
| Budget | `complex` |
| Preset | `module` |
| Module | `cli-host` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'P4 CLI sandbox commands' --module cli-host --preset module '<target>' |
| Budget | complex |
