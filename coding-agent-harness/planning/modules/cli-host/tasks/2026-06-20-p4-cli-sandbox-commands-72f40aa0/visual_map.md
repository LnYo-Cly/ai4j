...
| GATE-01 | gate | VERIFY-01 | planned | 0 | Agent Review Submission | `review.md`、progress update、lesson routing | `harness task-review MODULES/cli-host/2026-06-20-p4-cli-sandbox-commands-72f40aa0 --message "<summary>" .` | agent | present | requires clean tree or lifecycle-owned commit boundary | coordinator |
