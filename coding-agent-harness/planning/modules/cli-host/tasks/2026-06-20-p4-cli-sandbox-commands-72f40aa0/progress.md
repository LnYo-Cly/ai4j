...
### [2026-06-20 05:15] - task-review

- 做了什么：P4 CLI sandbox commands ready for review: /sandbox status attach disable implemented, metadata-only attach fails loudly without provider bridge, targeted and broad CLI tests plus docs build passed.
- 验证结果：已记录
- 下一步：继续执行
- 证据：n/a
