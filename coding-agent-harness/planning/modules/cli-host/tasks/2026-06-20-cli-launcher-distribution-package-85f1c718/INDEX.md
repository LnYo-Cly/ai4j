# CLI launcher distribution package - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-20-cli-launcher-distribution-package-85f1c718` |
| Budget | `complex` |
| Preset | `module` |
| Module | `cli-host` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'CLI launcher distribution package' --module cli-host --preset module '<target>' |
| Budget | complex |
