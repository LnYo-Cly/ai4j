# CLI memory compact command UX - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-20-cli-memory-compact-command-ux-d56c15fd` |
| Budget | `complex` |
| Preset | `module` |
| Module | `cli-host` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'CLI memory compact command UX' --module cli-host --preset module '<target>' |
| Budget | complex |
