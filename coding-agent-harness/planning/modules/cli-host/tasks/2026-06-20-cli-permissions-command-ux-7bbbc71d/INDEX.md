# CLI permissions command UX - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-20-cli-permissions-command-ux-7bbbc71d` |
| Budget | `complex` |
| Preset | `module` |
| Module | `cli-host` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'CLI permissions command UX' --module cli-host --preset module '<target>' |
| Budget | complex |
