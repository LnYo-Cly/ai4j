# ChatFire OpenAI videos service implementation - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-03-chatfire-openai-videos-service-implementation-b2ffc35a` |
| Budget | `standard` |
| Preset | `module` |
| Module | `core-sdk` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'ChatFire OpenAI videos service implementation' --module core-sdk --preset module '<target>' |
| Budget | standard |
