# ChatFire media generation integration analysis - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-03-chatfire-media-generation-integration-analysis-3697f321` |
| Budget | `simple` |
| Preset | `module` |
| Module | `core-sdk` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget simple --locale zh-CN --title 'ChatFire media generation integration analysis' --module core-sdk --preset module '<target>' |
| Budget | simple |
