# Add Anthropic Messages adapter - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-22-add-anthropic-messages-adapter-3876ee40` |
| Budget | `standard` |
| Preset | `module` |
| Module | `core-sdk` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'Add Anthropic Messages adapter' --module core-sdk --preset module '<target>' |
| Budget | standard |
