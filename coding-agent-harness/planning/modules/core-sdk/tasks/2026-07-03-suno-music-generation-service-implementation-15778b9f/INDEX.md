# Suno music generation service implementation - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-03-suno-music-generation-service-implementation-15778b9f` |
| Budget | `standard` |
| Preset | `module` |
| Module | `core-sdk` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'Suno music generation service implementation' --module core-sdk --preset module '<target>' |
| Budget | standard |
