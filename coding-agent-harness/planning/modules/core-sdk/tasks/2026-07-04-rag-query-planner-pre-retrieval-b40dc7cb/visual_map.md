...
| GATE-01 | gate | EXEC-01 | done | 100 | Agent Review Submission 待 lifecycle CLI 标记 | `review.md`、progress update、lesson routing | `harness task-review 2026-07-04-rag-query-planner-pre-retrieval-b40dc7cb --message "<summary>"` | agent | present | none | coordinator |
