# RAG query planner pre retrieval - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-04-rag-query-planner-pre-retrieval-b40dc7cb` |
| Budget | `standard` |
| Preset | `module` |
| Module | `core-sdk` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'RAG query planner pre retrieval' --module core-sdk --preset module '<target>' |
| Budget | standard |
