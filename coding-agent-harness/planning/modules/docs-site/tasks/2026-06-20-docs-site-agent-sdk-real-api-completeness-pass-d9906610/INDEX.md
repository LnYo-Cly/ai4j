# docs site agent sdk real api completeness pass - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-20-docs-site-agent-sdk-real-api-completeness-pass-d9906610` |
| Budget | `complex` |
| Preset | `module` |
| Module | `docs-site` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'docs site agent sdk real api completeness pass' --module docs-site --preset module '<target>' |
| Budget | complex |
