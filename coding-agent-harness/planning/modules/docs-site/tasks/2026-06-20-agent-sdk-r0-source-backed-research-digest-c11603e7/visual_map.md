...
| GATE-01 | gate | EXEC-01 | done | 100 | Agent Review Submission | `review.md`、progress update、lesson routing | `harness task-review MODULES/docs-site/2026-06-20-agent-sdk-r0-source-backed-research-digest-c11603e7 --message "<summary>"` | agent | present | requires clean tree after commit | coordinator |
