# Agent SDK R0 source backed research digest - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-20-agent-sdk-r0-source-backed-research-digest-c11603e7` |
| Budget | `complex` |
| Preset | `module` |
| Module | `docs-site` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'Agent SDK R0 source backed research digest' --module docs-site --preset module '<target>' |
| Budget | complex |
