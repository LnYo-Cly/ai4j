# Agent SDK task decomposition and technical docs - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-21-agent-sdk-task-decomposition-and-technical-docs-5ac6fa9e` |
| Budget | `complex` |
| Preset | `module` |
| Module | `docs-site` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'Agent SDK task decomposition and technical docs' --module docs-site --preset module '<target>' |
| Budget | complex |
