...
| T-AGENT-SDK-TASK-DECOMPOSITION-AND-TECHNICAL-DOCS- | Agent SDK task decomposition and technical docs | active | coding-agent-harness/planning/modules/docs-site/tasks/2026-06-21-agent-sdk-task-decomposition-and-technical-docs-5ac6fa9e/task_plan.md | T-AGENT-SDK-R0-SOURCE-BACKED-RESEARCH-DIGEST-C1160 |
