...
| T-AGENTHOOKS-FACADE-NAMED-PER-EVENT-SUGAR-OVER-INT | AgentHooks facade — named per-event sugar over interceptors | reserved | coding-agent-harness/planning/modules/agent-runtime/tasks/2026-07-01-agenthooks-facade-named-per-event-sugar-over-int-fb856d80/task_plan.md | T-AGENT-OBSERVABILITY-ENHANCEMENT-57C03F6B |
...
| T-COMPLETE-HOOK-EVENT-COVERAGE-POSTTOOLUSE-INTERCE | Complete hook event coverage (PostToolUse interception + observe bridge for Stop/PreCompact/Session) | active | coding-agent-harness/planning/modules/agent-runtime/tasks/2026-06-30-complete-hook-event-coverage-posttooluse-interce-cb698f06/task_plan.md | T-AI4J-AGENT-SDK-ARCHITECTURE-ENHANCEMENT-ROADMAP- |
