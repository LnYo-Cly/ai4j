...
| T-USERPROMPTSUBMIT-INTERCEPTION-HOOK-BLOCK-MODIFY- | UserPromptSubmit interception hook (block/modify user prompt) | reserved | coding-agent-harness/planning/modules/agent-runtime/tasks/2026-06-30-userpromptsubmit-interception-hook-block-modify-bcd16d20/task_plan.md | T-TOOL-INTERCEPTOR-HOOKS-PI-ALIGNED-OBSERVE-BLOCK- |
