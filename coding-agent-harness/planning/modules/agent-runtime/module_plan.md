...
| T-MEMORY-COMPACT-SESSION-API-POLISH-53845A17 | Memory Compact Session API polish | reserved | coding-agent-harness/planning/modules/agent-runtime/tasks/2026-06-20-memory-compact-session-api-polish-53845a17/task_plan.md | T-AI4J-AGENT-SDK-ARCHITECTURE-ENHANCEMENT-ROADMAP- |
