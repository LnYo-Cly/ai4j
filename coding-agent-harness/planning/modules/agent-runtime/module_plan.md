...
| T-AGENTHOOKS-FACADE-NAMED-PER-EVENT-SUGAR-OVER-INT | AgentHooks facade — named per-event sugar over interceptors | active | coding-agent-harness/planning/modules/agent-runtime/tasks/2026-07-01-agenthooks-facade-named-per-event-sugar-over-int-fb856d80/task_plan.md | T-AGENT-OBSERVABILITY-ENHANCEMENT-57C03F6B |
| T-AI4J-AGENT-SDK-ARCHITECTURE-ENHANCEMENT-ROADMAP- | AI4J Agent SDK architecture enhancement roadmap | merged | coding-agent-harness/planning/modules/agent-runtime/tasks/2026-06-20-ai4j-agent-sdk-architecture-enhancement-roadmap-9effae81/task_plan.md | T-AGENTHOOKS-FACADE-NAMED-PER-EVENT-SUGAR-OVER-INT |
| T-AI4J-DYNAMIC-WORKFLOW-HOST-RUNTIME-74E36FFB | AI4J dynamic workflow host runtime | reserved | coding-agent-harness/planning/modules/agent-runtime/tasks/2026-07-06-ai4j-dynamic-workflow-host-runtime-74e36ffb/task_plan.md | T-AI4J-AGENT-SDK-ARCHITECTURE-ENHANCEMENT-ROADMAP- |
| T-COMPACTION-CUMULATIVE-FILE-TRACKING-A100D59F | Compaction cumulative file tracking | reserved | coding-agent-harness/planning/modules/agent-runtime/tasks/2026-07-01-compaction-cumulative-file-tracking-a100d59f/task_plan.md | T-AI4J-DYNAMIC-WORKFLOW-HOST-RUNTIME-74E36FFB |
| T-COMPACTION-TURN-BOUNDARY-SAFE-CUT-POINT-04457184 | Compaction turn-boundary safe cut point | reserved | coding-agent-harness/planning/modules/agent-runtime/tasks/2026-07-01-compaction-turn-boundary-safe-cut-point-04457184/task_plan.md | T-COMPACTION-CUMULATIVE-FILE-TRACKING-A100D59F |
| T-COMPLETE-COMPACTION-SHOULDCOMPACT-A2A-SERVER-EXP | Complete compaction (shouldCompact) + A2A server (expose agent) | reserved | coding-agent-harness/planning/modules/agent-runtime/tasks/2026-07-01-complete-compaction-shouldcompact-a2a-server-exp-f8ea6b62/task_plan.md | T-COMPACTION-TURN-BOUNDARY-SAFE-CUT-POINT-04457184 |
| T-COMPLETE-HOOK-EVENT-COVERAGE-POSTTOOLUSE-INTERCE | Complete hook event coverage (PostToolUse interception + observe bridge for Stop/PreCompact/Session) | active | coding-agent-harness/planning/modules/agent-runtime/tasks/2026-06-30-complete-hook-event-coverage-posttooluse-interce-cb698f06/task_plan.md | T-COMPLETE-COMPACTION-SHOULDCOMPACT-A2A-SERVER-EXP |
| T-LLMCOMPACTPOLICY-LLM-POWERED-SUMMARIES-DOCS-FOR- | LlmCompactPolicy (LLM-powered summaries) + docs for compaction/A2A/hooks | reserved | coding-agent-harness/planning/modules/agent-runtime/tasks/2026-07-01-llmcompactpolicy-llm-powered-summaries-docs-for-9ee48643/task_plan.md | T-COMPLETE-HOOK-EVENT-COVERAGE-POSTTOOLUSE-INTERCE |
| T-MESSAGES-MODEL-CLIENT-0F5BAD51 | Anthropic MessagesModelClient for agent | merged | coding-agent-harness/planning/modules/agent-runtime/tasks/2026-06-23-messages-model-client-0f5bad51/task_plan.md | T-LLMCOMPACTPOLICY-LLM-POWERED-SUMMARIES-DOCS-FOR- |
