...
| 步骤 ID | 名称 | 状态 | 任务计划 | 依赖 |
| --- | --- | --- | --- | --- |
| T-AGENT-BLUEPRINT-SCHEMA-EXPORT-AND-DOCS-HARDENING | Agent Blueprint schema export and docs hardening | handoff | coding-agent-harness/planning/modules/agent-runtime/tasks/2026-06-20-agent-blueprint-schema-export-and-docs-hardening-4741edc1/task_plan.md | none |
...
| T-CUBESANDBOX-SANDBOX-PROVIDER-ADAPTER-246DE1FB | CubeSandbox sandbox provider adapter | reserved | coding-agent-harness/planning/modules/agent-runtime/tasks/2026-06-21-cubesandbox-sandbox-provider-adapter-246de1fb/task_plan.md | T-AI4J-AGENT-SDK-ARCHITECTURE-ENHANCEMENT-ROADMAP- |
| T-MEMORY-COMPACT-SESSION-API-POLISH-53845A17 | Memory Compact Session API polish | handoff | coding-agent-harness/planning/modules/agent-runtime/tasks/2026-06-20-memory-compact-session-api-polish-53845a17/task_plan.md | T-CUBESANDBOX-SANDBOX-PROVIDER-ADAPTER-246DE1FB |
