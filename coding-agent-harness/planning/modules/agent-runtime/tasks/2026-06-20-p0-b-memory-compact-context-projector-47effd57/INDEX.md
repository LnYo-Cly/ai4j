# P0-B Memory Compact Context Projector - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-20-p0-b-memory-compact-context-projector-47effd57` |
| Budget | `complex` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'P0-B Memory Compact Context Projector' --module agent-runtime --preset module '<target>' |
| Budget | complex |
