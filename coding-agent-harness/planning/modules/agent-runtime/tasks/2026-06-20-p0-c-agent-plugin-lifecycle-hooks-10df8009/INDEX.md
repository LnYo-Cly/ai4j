# P0-C Agent plugin lifecycle hooks - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-20-p0-c-agent-plugin-lifecycle-hooks-10df8009` |
| Budget | `complex` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'P0-C Agent plugin lifecycle hooks' --module agent-runtime --preset module '<target>' |
| Budget | complex |
