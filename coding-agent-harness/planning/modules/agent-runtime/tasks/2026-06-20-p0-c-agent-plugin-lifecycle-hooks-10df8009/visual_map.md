...
| GATE-01 | gate | EXEC-03 | done | 100 | Agent Review Submission | `review.md`、progress update、lesson routing、cross-module regression | `harness task-review MODULES/agent-runtime/2026-06-20-p0-c-agent-plugin-lifecycle-hooks-10df8009 --message "<summary>" .` | agent | present | run after feature commit so CLI can write review metadata | coordinator |
