# Compaction cumulative file tracking - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-01-compaction-cumulative-file-tracking-a100d59f` |
| Budget | `simple` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget simple --locale zh-CN --title 'Compaction cumulative file tracking' --module agent-runtime --preset module '<target>' |
| Budget | simple |
...
| Preset | `module` |
| Preset Version | `1` |
| Evidence Bundle | `coding-agent-harness/planning/modules/agent-runtime/tasks/2026-07-01-compaction-cumulative-file-tracking-a100d59f/artifacts/preset/2026-07-01T03-20-55-593Z` |
