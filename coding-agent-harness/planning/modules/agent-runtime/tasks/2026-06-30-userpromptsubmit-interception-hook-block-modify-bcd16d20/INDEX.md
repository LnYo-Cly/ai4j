# UserPromptSubmit interception hook (block/modify user prompt) - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-30-userpromptsubmit-interception-hook-block-modify-bcd16d20` |
| Budget | `standard` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'UserPromptSubmit interception hook (block/modify user prompt)' --module agent-runtime --preset module '<target>' |
| Budget | standard |
...
| Preset | `module` |
| Preset Version | `1` |
| Evidence Bundle | `coding-agent-harness/planning/modules/agent-runtime/tasks/2026-06-30-userpromptsubmit-interception-hook-block-modify-bcd16d20/artifacts/preset/2026-06-30T10-10-09-321Z` |
