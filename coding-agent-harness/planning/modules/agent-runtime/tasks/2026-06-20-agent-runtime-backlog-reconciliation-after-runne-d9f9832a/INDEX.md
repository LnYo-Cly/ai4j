# Agent Runtime backlog reconciliation after runner merge - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-20-agent-runtime-backlog-reconciliation-after-runne-d9f9832a` |
| Budget | `standard` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'Agent Runtime backlog reconciliation after runner merge' --module agent-runtime --preset module '<target>' |
| Budget | standard |
