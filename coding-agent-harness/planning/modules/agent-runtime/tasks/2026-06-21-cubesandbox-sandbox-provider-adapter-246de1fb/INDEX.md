# CubeSandbox sandbox provider adapter - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-21-cubesandbox-sandbox-provider-adapter-246de1fb` |
| Budget | `complex` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'CubeSandbox sandbox provider adapter' --module agent-runtime --preset module '<target>' |
| Budget | complex |
