# P1-B Agent Blueprint to AgentFactory - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-20-p1-b-agent-blueprint-to-agentfactory-8b418210` |
| Budget | `complex` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'P1-B Agent Blueprint to AgentFactory' --module agent-runtime --preset module '<target>' |
| Budget | complex |
