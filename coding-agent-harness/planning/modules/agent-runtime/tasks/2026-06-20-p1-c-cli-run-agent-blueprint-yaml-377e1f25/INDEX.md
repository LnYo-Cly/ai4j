# P1-C CLI run Agent Blueprint YAML - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-20-p1-c-cli-run-agent-blueprint-yaml-377e1f25` |
| Budget | `complex` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'P1-C CLI run Agent Blueprint YAML' --module agent-runtime --preset module '<target>' |
| Budget | complex |
