# Memory Compact Session API polish - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-20-memory-compact-session-api-polish-53845a17` |
| Budget | `complex` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'Memory Compact Session API polish' --module agent-runtime --preset module '<target>' |
| Budget | complex |
