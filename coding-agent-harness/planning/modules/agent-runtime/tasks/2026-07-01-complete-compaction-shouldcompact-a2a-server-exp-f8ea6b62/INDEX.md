# Complete compaction (shouldCompact) + A2A server (expose agent) - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-01-complete-compaction-shouldcompact-a2a-server-exp-f8ea6b62` |
| Budget | `standard` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'Complete compaction (shouldCompact) + A2A server (expose agent)' --module agent-runtime --preset module '<target>' |
| Budget | standard |
...
| Preset | `module` |
| Preset Version | `1` |
| Evidence Bundle | `coding-agent-harness/planning/modules/agent-runtime/tasks/2026-07-01-complete-compaction-shouldcompact-a2a-server-exp-f8ea6b62/artifacts/preset/2026-06-30T20-18-33-297Z` |
