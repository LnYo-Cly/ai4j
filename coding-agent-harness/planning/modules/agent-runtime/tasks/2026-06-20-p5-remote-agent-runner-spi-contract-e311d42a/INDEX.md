# P5 Remote Agent Runner SPI contract - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-20-p5-remote-agent-runner-spi-contract-e311d42a` |
| Budget | `complex` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'P5 Remote Agent Runner SPI contract' --module agent-runtime --preset module '<target>' |
| Budget | complex |
