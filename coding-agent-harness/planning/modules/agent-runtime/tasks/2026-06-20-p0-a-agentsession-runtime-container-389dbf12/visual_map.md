...
| GATE-01 | gate | VERIFY-01 | done | 100 | Agent Review Submission | `review.md`; `lesson_candidates.md`; final progress evidence | `harness task-review MODULES/agent-runtime/2026-06-20-p0-a-agentsession-runtime-container-389dbf12 --message "<summary>" .` | agent | present | cannot submit before clean commit/materials | coordinator |
