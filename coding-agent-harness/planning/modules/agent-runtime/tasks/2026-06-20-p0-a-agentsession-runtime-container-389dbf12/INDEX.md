# P0-A AgentSession runtime container - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-20-p0-a-agentsession-runtime-container-389dbf12` |
| Budget | `complex` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'P0-A AgentSession runtime container' --module agent-runtime --preset module '<target>' |
| Budget | complex |
