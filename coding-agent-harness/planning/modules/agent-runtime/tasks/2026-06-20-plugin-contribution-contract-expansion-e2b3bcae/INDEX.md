# Plugin contribution contract expansion - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-20-plugin-contribution-contract-expansion-e2b3bcae` |
| Budget | `complex` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'Plugin contribution contract expansion' --module agent-runtime --preset module '<target>' |
| Budget | complex |
