# Agent durable session store (JDBC) + resume cache persistence - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-24-agent-durable-session-store-jdbc-resume-cache-pe-2cc9cf5d` |
| Budget | `complex` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'Agent durable session store (JDBC) + resume cache persistence' --module agent-runtime --preset module '<target>' |
| Budget | complex |
...
| Preset | `module` |
| Preset Version | `1` |
| Evidence Bundle | `coding-agent-harness/planning/modules/agent-runtime/tasks/2026-06-24-agent-durable-session-store-jdbc-resume-cache-pe-2cc9cf5d/artifacts/preset/2026-06-24T02-31-22-954Z` |
