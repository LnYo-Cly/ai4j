# Agent observability enhancement - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-22-agent-observability-enhancement-57c03f6b` |
| Budget | `complex` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'Agent observability enhancement' --module agent-runtime --preset module '<target>' |
| Budget | complex |
