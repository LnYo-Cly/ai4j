# P2-B AgentSession sandbox binding - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-20-p2-b-agentsession-sandbox-binding-e8175553` |
| Budget | `complex` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'P2-B AgentSession sandbox binding' --module agent-runtime --preset module '<target>' |
| Budget | complex |
