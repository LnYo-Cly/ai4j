...
| GATE-01 | gate | EXEC-02 | planned | 0 | Agent Review Submission | `review.md`; lesson decision; harness status | `harness task-review ...` | agent | missing | pending validation | coordinator |
