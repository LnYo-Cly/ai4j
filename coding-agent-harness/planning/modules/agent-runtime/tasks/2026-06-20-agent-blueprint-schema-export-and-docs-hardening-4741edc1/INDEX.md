# Agent Blueprint schema export and docs hardening - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-20-agent-blueprint-schema-export-and-docs-hardening-4741edc1` |
| Budget | `complex` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'Agent Blueprint schema export and docs hardening' --module agent-runtime --preset module '<target>' |
| Budget | complex |
