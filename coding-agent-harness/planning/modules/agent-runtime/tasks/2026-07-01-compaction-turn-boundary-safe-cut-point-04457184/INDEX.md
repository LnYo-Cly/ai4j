# Compaction turn-boundary safe cut point - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-01-compaction-turn-boundary-safe-cut-point-04457184` |
| Budget | `simple` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget simple --locale zh-CN --title 'Compaction turn-boundary safe cut point' --module agent-runtime --preset module '<target>' |
| Budget | simple |
...
| Preset | `module` |
| Preset Version | `1` |
| Evidence Bundle | `coding-agent-harness/planning/modules/agent-runtime/tasks/2026-07-01-compaction-turn-boundary-safe-cut-point-04457184/artifacts/preset/2026-07-01T02-41-37-966Z` |
