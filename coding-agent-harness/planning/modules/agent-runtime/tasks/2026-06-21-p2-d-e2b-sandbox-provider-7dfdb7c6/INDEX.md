# P2-D E2B sandbox provider - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-21-p2-d-e2b-sandbox-provider-7dfdb7c6` |
| Budget | `complex` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'P2-D E2B sandbox provider' --module agent-runtime --preset module '<target>' |
| Budget | complex |
