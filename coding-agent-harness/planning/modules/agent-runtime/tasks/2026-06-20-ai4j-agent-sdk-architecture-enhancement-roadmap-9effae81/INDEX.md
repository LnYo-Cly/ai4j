# AI4J Agent SDK architecture enhancement roadmap - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-20-ai4j-agent-sdk-architecture-enhancement-roadmap-9effae81` |
| Budget | `complex` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'AI4J Agent SDK architecture enhancement roadmap' --module agent-runtime --preset module '<target>' |
| Budget | complex |
