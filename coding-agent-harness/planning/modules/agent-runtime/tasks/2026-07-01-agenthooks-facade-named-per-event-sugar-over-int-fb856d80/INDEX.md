# AgentHooks facade — named per-event sugar over interceptors - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-01-agenthooks-facade-named-per-event-sugar-over-int-fb856d80` |
| Budget | `standard` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentHooks facade — named per-event sugar over interceptors' --module agent-runtime --preset module '<target>' |
| Budget | standard |
...
| Preset | `module` |
| Preset Version | `1` |
| Evidence Bundle | `coding-agent-harness/planning/modules/agent-runtime/tasks/2026-07-01-agenthooks-facade-named-per-event-sugar-over-int-fb856d80/artifacts/preset/2026-06-30T16-34-25-059Z` |
