# Wire compaction into runtime loop (auto-trigger + before-compact hook) - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-01-wire-compaction-into-runtime-loop-auto-trigger-b-de7e4c74` |
| Budget | `complex` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'Wire compaction into runtime loop (auto-trigger + before-compact hook)' --module agent-runtime --preset module '<target>' |
| Budget | complex |
...
| Preset | `module` |
| Preset Version | `1` |
| Evidence Bundle | `coding-agent-harness/planning/modules/agent-runtime/tasks/2026-07-01-wire-compaction-into-runtime-loop-auto-trigger-b-de7e4c74/artifacts/preset/2026-06-30T16-56-00-915Z` |
