# Wire compaction into runtime loop (auto-trigger + before-compact hook) - 教训候选
...
| Source task | 2026-07-01-wire-compaction-into-runtime-loop-auto-trigger-b-de7e4c74 |
| Owner | coordinator |
