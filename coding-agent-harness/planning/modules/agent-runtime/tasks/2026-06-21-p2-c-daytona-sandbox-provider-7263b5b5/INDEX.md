# P2-C Daytona sandbox provider - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-21-p2-c-daytona-sandbox-provider-7263b5b5` |
| Budget | `complex` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'P2-C Daytona sandbox provider' --module agent-runtime --preset module '<target>' |
| Budget | complex |
