...
| GATE-01 | gate | VERIFY-01 | planned | 0 | Agent Review Submission | `review.md`; `lesson_candidates.md`; final progress evidence | `harness task-review MODULES/agent-runtime/2026-06-20-p0-d-agent-approval-and-permission-policy-95b57bb5 --message "<summary>" .` | agent | missing | cannot submit before clean commit/materials | coordinator |
