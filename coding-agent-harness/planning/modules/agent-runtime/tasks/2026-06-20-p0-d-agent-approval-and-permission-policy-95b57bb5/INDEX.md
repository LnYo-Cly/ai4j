# P0-D Agent approval and permission policy - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-20-p0-d-agent-approval-and-permission-policy-95b57bb5` |
| Budget | `complex` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'P0-D Agent approval and permission policy' --module agent-runtime --preset module '<target>' |
| Budget | complex |
