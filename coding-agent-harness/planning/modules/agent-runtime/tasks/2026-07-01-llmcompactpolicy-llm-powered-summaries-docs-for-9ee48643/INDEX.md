# LlmCompactPolicy (LLM-powered summaries) + docs for compaction/A2A/hooks - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-01-llmcompactpolicy-llm-powered-summaries-docs-for-9ee48643` |
| Budget | `standard` |
| Preset | `module` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'LlmCompactPolicy (LLM-powered summaries) + docs for compaction/A2A/hooks' --module agent-runtime --preset module '<target>' |
| Budget | standard |
...
| Preset | `module` |
| Preset Version | `1` |
| Evidence Bundle | `coding-agent-harness/planning/modules/agent-runtime/tasks/2026-07-01-llmcompactpolicy-llm-powered-summaries-docs-for-9ee48643/artifacts/preset/2026-07-01T00-58-25-441Z` |
