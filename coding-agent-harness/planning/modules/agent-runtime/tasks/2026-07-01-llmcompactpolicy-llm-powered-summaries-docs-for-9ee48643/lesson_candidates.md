# LlmCompactPolicy (LLM-powered summaries) + docs for compaction/A2A/hooks - 教训候选
...
| Source task | 2026-07-01-llmcompactpolicy-llm-powered-summaries-docs-for-9ee48643 |
| Owner | coordinator |
