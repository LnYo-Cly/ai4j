# Tool interceptor hooks (pi-aligned: observe/block/modify/route-to-sandbox) - 教训候选
...
| Source task | 2026-06-30-tool-interceptor-hooks-pi-aligned-observe-block-d042a8cd |
| Owner | coordinator |
