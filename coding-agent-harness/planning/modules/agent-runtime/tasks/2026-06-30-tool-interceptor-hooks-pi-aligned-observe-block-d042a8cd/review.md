# Tool interceptor hooks (pi-aligned: observe/block/modify/route-to-sandbox) - 审查
...
| Task Key | 2026-06-30-tool-interceptor-hooks-pi-aligned-observe-block-d042a8cd |
