...
`ai4j-sdk` 是 Java 8 Maven monorepo，提供统一大模型 SDK、Agent runtime、Coding Agent runtime、CLI/TUI/ACP、Spring Boot starters、FlowGram starter/demo、BOM，以及相邻的 Docusaurus 文档站和 FlowGram Web demo。
...
| --- | --- | --- | --- | --- | --- |
| ARCH-001 | 根 `pom.xml` 定义 8 个 Maven module，Java baseline 为 1.8。 | `pom.xml` | 2026-06-04 | high | `AGENTS.md` |
