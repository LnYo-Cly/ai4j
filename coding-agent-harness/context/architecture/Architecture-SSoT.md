...
`ai4j-sdk` 是 Java 8 Maven monorepo，提供轻量扩展 API、官方插件样板、统一大模型 SDK、Agent runtime、Coding Agent runtime、CLI/TUI/ACP、Spring Boot starters、FlowGram starter/demo、BOM，以及相邻的 Docusaurus 文档站和 FlowGram Web demo。
...
| --- | --- | --- | --- | --- | --- |
| ARCH-001 | 根 `pom.xml` 定义 10 个 Maven module，Java baseline 为 1.8。 | `pom.xml` | 2026-06-09 | high | `AGENTS.md` |
...
| ARCH-009 | `ai4j-plugin-ask-user/` 是官方插件样板模块，负责 host-mediated 用户提问 tool、command、Skill、Prompt、ServiceLoader 注册和 validator 测试。 | `ai4j-plugin-ask-user/pom.xml`; `ai4j-plugin-ask-user/src/main/java`; `docs-site/docs/core-sdk/extension/ask-user-plugin.md` | 2026-06-09 | high | `docs/11-REFERENCE/engineering-standard.md` |
