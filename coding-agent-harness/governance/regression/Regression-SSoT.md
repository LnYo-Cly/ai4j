...
| RG-009 | FlowGram webapp demo build | `npm run lint`, `npm run ts-check`, then `npm run build` in `ai4j-flowgram-webapp-demo/` | `ai4j-flowgram-webapp-demo/` frontend changes | L2-local-smoke | 2026-06-09 local and remote pass | pass-with-residual | project coordinator | R-003 |
