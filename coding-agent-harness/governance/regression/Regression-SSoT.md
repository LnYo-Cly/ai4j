...
| RG-004 | CLI/TUI/ACP host | `mvn -pl ai4j-cli -am -DskipTests=false test` | `ai4j-cli/` CLI, TUI, ACP, session, rendering changes | L1-tests | 2026-06-09 direct CLI suite pass / `-am` blocked by R-008 | pass-with-residual | project coordinator | R-001, R-008 |
