...
| RG-004 | CLI/TUI/ACP host | `mvn -pl ai4j-cli -am -DskipTests=false test` | `ai4j-cli/` CLI, TUI, ACP, session, rendering changes | L1-tests | 2026-06-09 targeted pass / direct suite blocked by R-009 / `-am` blocked by R-008 | pass-with-residual | project coordinator | R-001, R-008, R-009 |
...
| R-009 | RG-004 | `mvn -pl ai4j-cli -DfailIfNoTests=false -DskipTests=false test` currently fails outside extension scaffold in `JlineShellTerminalIOTest` and `AcpCommandTest` assertion drift; `Ai4jCliTest` targeted extension scaffold coverage remains green. | P1 | project coordinator | 2026-06-09 | `coding-agent-harness/planning/tasks/2026-06-09-ai4j-extension-scaffold-author-experience-wave-1-50e4b9e6/progress.md` | open |
