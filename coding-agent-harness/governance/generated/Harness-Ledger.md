...
| HL-2026-06-04-regression-baseline-live-split-b2f834db | task | none | regression baseline live split | review | none | coding-agent-harness/planning/tasks/2026-06-04-regression-baseline-live-split-b2f834db/task_plan.md | coding-agent-harness/planning/tasks/2026-06-04-regression-baseline-live-split-b2f834db/review.md | pending | pending | Regression baseline/live split ready for review: v2 SSoT and Cadence separate local-required from live-provider and credential-release opt-in gates; legacy docs projection synced; harness status pass with 0 failures and 0 warnings; executable regressions waived because this is governance-only. | 2026-06-04 |
