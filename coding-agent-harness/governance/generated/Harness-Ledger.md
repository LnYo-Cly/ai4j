...
| HL-2026-06-04-regression-baseline-live-split-b2f834db | task | none | regression baseline live split | active | none | coding-agent-harness/planning/tasks/2026-06-04-regression-baseline-live-split-b2f834db/task_plan.md | pending | pending | pending | Updated regression governance split: local-required baseline, live-provider opt-in gates, credential-release opt-in gate, cadence terms, minimum evidence depth, and residual routing for live profiles/provider hygiene/webapp CI. | 2026-06-04 |
