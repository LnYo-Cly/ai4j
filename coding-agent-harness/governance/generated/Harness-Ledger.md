...
| HL-2026-06-06-5-c6e2fa16 | task | none | 5 分钟首聊主路径文档 | active | none | coding-agent-harness/planning/tasks/2026-06-06-5-c6e2fa16/task_plan.md | pending | pending | pending | 开始重构 docs-site 的 5 分钟首聊主路径，范围包含入口、Quickstart、Skill 安装指引和文档构建验证。 | 2026-06-06 |
