...
| HL-2026-06-04-module-parallel-harness-upgrade-d6ab88ce | task | none | module parallel harness upgrade | active | none | coding-agent-harness/planning/tasks/2026-06-04-module-parallel-harness-upgrade-d6ab88ce/task_plan.md | pending | pending | pending | Start module-parallel harness upgrade. Current harness has core,dashboard only; module registry is empty; ai4j-sdk is an 8-module Java Maven monorepo with docs and frontend demo surfaces, so module-parallel applies. | 2026-06-04 |
