...
| HL-2026-06-07-core-sdk-configuration-and-invocation-experience-c7555c2f | task | none | Core SDK configuration and invocation experience upgrade design | active | none | coding-agent-harness/planning/tasks/2026-06-07-core-sdk-configuration-and-invocation-experience-c7555c2f/task_plan.md | pending | pending | pending | 开始 Core SDK 配置与调用体验升级设计；本轮只做设计，不改 Java API。 | 2026-06-07 |
