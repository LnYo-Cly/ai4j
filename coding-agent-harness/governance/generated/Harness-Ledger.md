...
| HL-2026-06-04-docs-site-information-architecture-redesign-6c91ba27 | task | none | docs site information architecture redesign | review | none | coding-agent-harness/planning/tasks/2026-06-04-docs-site-information-architecture-redesign-6c91ba27/task_plan.md | coding-agent-harness/planning/tasks/2026-06-04-docs-site-information-architecture-redesign-6c91ba27/review.md | pending | pending | docs-site IA redesign design packet ready for human review: current inventory, target layered IA, Feature Map strategy, status labels, page contracts, and migration waves are documented; implementation is intentionally deferred pending approval. | 2026-06-04 |
