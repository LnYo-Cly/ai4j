...
| 步骤 ID | 名称 | 状态 | 任务计划 | 依赖 |
| --- | --- | --- | --- | --- |
| T-CLI-EXTERNAL-COMMAND-TOOL-HOOKS-CLAUDE-CODE-STYL | CLI external-command tool hooks (Claude-Code-style PreToolUse) | active | coding-agent-harness/planning/modules/cli-host/tasks/2026-06-30-cli-external-command-tool-hooks-claude-code-styl-d5fcaba8/task_plan.md | none |
