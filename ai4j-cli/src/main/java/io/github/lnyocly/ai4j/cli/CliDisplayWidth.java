...
final class CliDisplayWidth {
    ...
    static String clip(String value, int maxWidth) {
        if (value == null) {
            return "";
        }
    ...
    static String sliceByColumns(String text, int width) {
    ...
    static WrappedAnsi wrapAnsi(String ansiText, int terminalWidth, int startColumn) {
    ...
    static final class WrappedAnsi {
        private final String text;
        private final int endColumn;

        WrappedAnsi(String text, int endColumn) {
