...
final class CliThemeStyler {
    ...
    CliThemeStyler(TuiTheme theme, boolean ansi) {
    ...
    String styleTranscriptLine(String line) {
        return styleTranscriptLine(line, new TranscriptStyleState());
    }

    String styleTranscriptLine(String line, TranscriptStyleState state) {
    ...
    String buildPrimaryStatusLine(String statusLabel, boolean spinnerActive, String spinner, String statusDetail) {
    ...
    String buildCompactStatusLine(String statusLabel,
    ...
    String buildSessionLine(String sessionId, String model, String workspace) {
    ...
    String buildHintLine(String hint) {
        return styleMutedFragment("hint")
                + " " + styleMutedFragment(firstNonBlank(hint, "Enter a prompt or /command"));
    }

    String styleAssistantFragment(String text) {
        return CliAnsi.colorize(text, text(), ansi, false);
    }

    String styleReasoningFragment(String text) {
        return CliAnsi.colorize(text, muted(), ansi, false);
    }

    String styleMutedFragment(String text) {
        return CliAnsi.colorize(text, muted(), ansi, false);
    }

    String styleTranscriptCodeLine(String line, String language) {
    ...
    static final class TranscriptStyleState {

        private String codeBlockLanguage;
        private boolean insideCodeBlock;

        void enterCodeBlock(String language) {
