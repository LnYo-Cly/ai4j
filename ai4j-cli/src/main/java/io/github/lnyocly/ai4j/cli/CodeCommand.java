...
public class CodeCommand {
    ...
    public int run(List<String> args, TerminalIO terminal) {
        ...
        try {
            ...
            CodingCliAgentFactory.PreparedCodingAgent prepared = agentFactory.prepare(options, runtimeTerminal, interactionState);
            ...
            return new CodingCliSessionRunner(agent,
                    prepared.getProtocol(),
                    options,
                    runtimeTerminal,
                    sessionManager,
    ...
    private void printHelp(TerminalIO terminal) {
        ...
        terminal.println("  --max-steps <n>                    Default: 12");
        terminal.println("  --max-tool-calls <n>               Default: 32");
        ...
        terminal.println("  /stream [on|off]  Show or switch transcript streaming");
        ...
        terminal.println("  TUI keys: / opens command list, Tab accepts completion, Ctrl+P palette, Ctrl+R replay, Enter submit, Esc clear input\n");
