...
[Discovery and Loading](/docs/core-sdk/skills/discovery-and-loading) 讲的是「SKILL.md 怎么被发现、目录怎么生成」。
...
- [Tool Exposure Semantics](/docs/mcp/tool-exposure-semantics) — 受限执行器和工具白名单的关系
- [Skills 总览](/docs/core-sdk/skills/overview) — Skill 在架构里的定位
