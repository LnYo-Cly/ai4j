...
1. [MCP 使用路径与场景选择](/docs/capabilities/mcp/use-cases-and-paths)
2. [MCP 传输类型详解](/docs/capabilities/mcp/transport-types)
3. [MCP Client 接入（单服务模式）](/docs/capabilities/mcp/client-integration)
4. [Tool 暴露语义与安全边界](/docs/capabilities/mcp/tool-exposure-semantics)
5. [MCP Gateway 管理](/docs/capabilities/mcp/gateway-management)
6. [构建并对外发布 MCP Server](/docs/capabilities/mcp/build-your-mcp-server)
