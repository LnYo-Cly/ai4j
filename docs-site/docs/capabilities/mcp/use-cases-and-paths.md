...
1. [MCP 传输类型详解](/docs/capabilities/mcp/transport-types)
2. [MCP Client 接入（单服务模式）](/docs/capabilities/mcp/client-integration)
3. [接入第三方 MCP（全部方式）](/docs/capabilities/mcp/third-party-mcp-integration)
...
1. [MCP Gateway 管理](/docs/capabilities/mcp/gateway-management)
2. [Tool 暴露语义与安全边界](/docs/capabilities/mcp/tool-exposure-semantics)
3. [接入第三方 MCP（全部方式）](/docs/capabilities/mcp/third-party-mcp-integration)
...
1. [构建并对外发布 MCP Server](/docs/capabilities/mcp/build-your-mcp-server)
2. [MCP 传输类型详解](/docs/capabilities/mcp/transport-types)
3. [Tool 暴露语义与安全边界](/docs/capabilities/mcp/tool-exposure-semantics)
