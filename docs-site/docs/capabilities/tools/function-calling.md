...
- [Tools / Annotation-based Tools](/docs/capabilities/tools/annotation-based-tools)
- [Tools / Tool Execution Model](/docs/capabilities/tools/tool-execution-model)
- [Skills / Skill vs Tool vs MCP](/docs/capabilities/skills/skill-vs-tool-vs-mcp)
