...
1. [配置体系](/docs/products/coding-agent/configuration)
2. [命令参考](/docs/products/coding-agent/command-reference)
3. [CLI / TUI 使用指南](/docs/products/coding-agent/cli-and-tui)
