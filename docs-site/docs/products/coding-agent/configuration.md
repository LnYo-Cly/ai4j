...
1. [Provider Profile 与模型切换](/docs/products/coding-agent/provider-profiles)
2. [CLI / TUI 使用指南](/docs/products/coding-agent/cli-and-tui)
3. [命令参考](/docs/products/coding-agent/command-reference)
4. [MCP 对接](/docs/products/coding-agent/mcp-integration)
