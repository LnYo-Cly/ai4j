...
| 层级 | 能力 | 入口 |
| --- | --- | --- |
| Core SDK | `Chat`、`Responses`、流式、多模态、图像、音频、Embedding、Rerank | [Core SDK / Model Access](/docs/capabilities/models/overview) |
| 能力接入 | Function Call、本地工具、Skill、MCP | [Tools](/docs/capabilities/tools/overview)、[Skills](/docs/capabilities/skills/overview)、[MCP](/docs/capabilities/mcp/overview) |
| 数据增强 | Memory、Search、RAG、VectorStore、Ingestion、Hybrid Retrieval | [Search & RAG](/docs/capabilities/rag/overview) |
