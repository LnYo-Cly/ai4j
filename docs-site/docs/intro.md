...
| 目标 | 推荐入口 | 你会得到什么 |
| --- | --- | --- |
| 普通 Java 跑通第一条 AI 请求 | [Quickstart for Java](/docs/start-here/quickstart-java) | 最小依赖、密钥配置、验证标准和第一条模型调用 |
...
| 查正式文档路径 | [Documentation Map](/docs/start-here/documentation-map) | canonical 主线、legacy 来源和迁移方向 |
| 上线前检查 | [Production Checklist](/docs/operations/production-checklist) | 版本、密钥、Tool、MCP、RAG、Agent、FlowGram 的检查项 |
...
| 生产准备 | 版本兼容、发布 artifact、安全、迁移、排障 | [Version Compatibility](/docs/reference/version-compatibility)、[Security](/docs/security/overview)、[Troubleshooting](/docs/troubleshooting/overview) |
