...
- 配置分层与其它 `ai.*` 前缀：见 [Configuration Reference](/docs/spring-boot/configuration-reference)
- 装配链与失败传播：见 [Spring Boot Auto Configuration](/docs/spring-boot/auto-configuration)
