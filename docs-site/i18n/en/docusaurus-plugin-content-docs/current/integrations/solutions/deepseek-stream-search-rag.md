...
- Private knowledge base only: start with [RAG Ingestion Vector Store](/docs/integrations/solutions/rag-ingestion-vector-store)
- Web search augmentation only: start with [SearXNG Web Search](/docs/integrations/solutions/searxng-web-search)
...
- [Legacy path case page](/docs/integrations/solutions/deepseek-stream-search-rag)
