...
`ai4j-spring-boot-starter` wires the Core SDK into Spring Boot's configuration, Bean lifecycle, and business layering. It is not a new AI implementation, nor is it a mandatory entry point — if you are not on a Spring project, start directly with the [Core SDK](/docs/capabilities/overview).
...
| --- | --- |
| Override default Beans | [Bean Extension](/docs/integrations/spring-boot/bean-extension) |
| Inspect configuration options | [Configuration Reference](/docs/integrations/spring-boot/configuration-reference) |
| Common business patterns | [Common Patterns](/docs/integrations/spring-boot/common-patterns) |
| Return to model and Tool semantics | [Core SDK](/docs/capabilities/overview) |
| Build a Spring-scoped solution | [Solutions](/docs/integrations/solutions/overview) |
...
1. [Quickstart](/docs/integrations/spring-boot/quickstart)
2. [Auto Configuration](/docs/integrations/spring-boot/auto-configuration)
3. [Configuration Reference](/docs/integrations/spring-boot/configuration-reference)
4. [Bean Extension](/docs/integrations/spring-boot/bean-extension)
5. [Common Patterns](/docs/integrations/spring-boot/common-patterns)
