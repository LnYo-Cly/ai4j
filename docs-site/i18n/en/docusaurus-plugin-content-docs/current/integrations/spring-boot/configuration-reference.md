...
Concurrency dispatch and connection pooling are not hard-coded; they are provided via SPI (see [Auto Configuration / OkHttp SPI extension points](/docs/integrations/spring-boot/auto-configuration#8-okhttp-spi-extension-points)):
