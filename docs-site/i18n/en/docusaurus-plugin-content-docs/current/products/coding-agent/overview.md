...
7. [Session Runtime](/docs/products/coding-agent/session-runtime)
...
If you want to compare Coding Agent with agent SDKs in the JS/TS ecosystem, see [Comparison](/docs/reference/about/comparison).
