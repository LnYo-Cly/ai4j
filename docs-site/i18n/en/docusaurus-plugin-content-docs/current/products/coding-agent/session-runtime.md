...
1. [Compact and checkpoint mechanism](/docs/products/coding-agent/compact-and-checkpoint)
2. [Tools and approval mechanism](/docs/products/coding-agent/tools-and-approvals)
3. [Runtime architecture](/docs/products/coding-agent/runtime-architecture)
