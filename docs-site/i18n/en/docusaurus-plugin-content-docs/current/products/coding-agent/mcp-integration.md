...
1. [MCP and ACP](/docs/products/coding-agent/mcp-and-acp)
2. [Tools and the approval mechanism](/docs/products/coding-agent/tools-and-approvals)
3. [ACP integration](/docs/products/coding-agent/acp-integration)
4. [MCP overview](/docs/capabilities/mcp/overview)
