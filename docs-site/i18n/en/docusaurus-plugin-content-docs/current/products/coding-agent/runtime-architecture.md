...
2. [Tools and the approval mechanism](/docs/products/coding-agent/tools-and-approvals)
3. [Compact and checkpoint mechanism](/docs/products/coding-agent/compact-and-checkpoint)
