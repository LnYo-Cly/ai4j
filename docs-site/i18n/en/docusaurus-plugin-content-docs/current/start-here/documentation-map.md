...
| Core SDK, models, Tool, Skill, RAG, foundational capabilities | [Core SDK](/docs/core-sdk/overview) | Regular Java or SDK integrators |
| MCP client, gateway, server, tool exposure | [MCP](/docs/mcp/overview) | Teams wiring up external tools or publishing Java capabilities |
| Spring Boot auto-configuration and Bean extensions | [Spring Boot](/docs/spring-boot/overview) | Spring application developers |
...
| Local repo tasks, CLI, TUI, ACP | [Coding Agent](/docs/coding-agent/overview) | Teams building a coding agent or local dev host |
| FlowGram.ai canvas backend execution layer | [FlowGram](/docs/flowgram/overview) | Teams building a visual workflow platform |
| Scenario cookbooks | [Solutions](/docs/solutions/overview) | Readers with a concrete business scenario |
| Versioning, release, security, migration, production checks | [Operations](/docs/operations/production-checklist) | Selection, rollout, and maintenance staff |
...
| Provider extension | [Extension](/docs/core-sdk/extension/overview) | `ai-basics/provider-and-model-extension` |
...
| FlowGram nodes and task API | [FlowGram Overview](/docs/flowgram/overview) | `flowgram/builtin-nodes` |
...
If you're still not sure which track to read, go back to [Choose Your Path](/docs/start-here/choose-your-path).
