...
This page gives a Spring Boot project the shortest path to success. For plain Java projects, use [Quickstart for Java](/docs/start-here/quickstart-java) directly.
...
For the full writeup, see [OpenAI-compatible and TroveBox](/docs/start-here/openai-compatible-and-trovebox).
...
- For the underlying `Chat` call semantics: see [Core SDK / Model Access / Chat](/docs/core-sdk/model-access/chat)
- To configure more providers: see [Spring Boot / Configuration Reference](/docs/spring-boot/configuration-reference)
- To extend Beans or reuse business services: see [Spring Boot / Bean Extension](/docs/spring-boot/bean-extension)
- For Tool / Function Call: see [First Tool Call](/docs/start-here/first-tool-call)
