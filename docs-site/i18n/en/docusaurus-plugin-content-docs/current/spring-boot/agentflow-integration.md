...
- Configuration layering and other `ai.*` prefixes: see [Configuration Reference](/docs/spring-boot/configuration-reference)
- Wiring chain and failure propagation: see [Spring Boot Auto Configuration](/docs/spring-boot/auto-configuration)
