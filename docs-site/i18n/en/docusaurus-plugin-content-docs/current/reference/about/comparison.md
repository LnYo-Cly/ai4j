...
The last five rows are hard technical differentiators you can restate directly in a selection doc: each is backed by corresponding module code and a docs page (see [Strengths and Differentiators](/docs/reference/about/strengths-and-differentiators)), not a roadmap promise.
