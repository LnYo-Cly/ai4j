...
| --- | --- | --- |
| `getting-started/installation` | [Quickstart for Java](/docs/getting-started/quickstart-java) | Migrating |
| `getting-started/quickstart-openai-jdk8` | [Quickstart for Java](/docs/getting-started/quickstart-java) | Migrating |
| `getting-started/quickstart-springboot` | [Quickstart for Spring Boot](/docs/getting-started/quickstart-spring-boot) | Migrating |
...
| `ai-basics/chat/*` | [Model Access](/docs/capabilities/models/overview) | Migrating |
| `ai-basics/responses/*` | [Model Access](/docs/capabilities/models/overview) | Migrating |
| `ai-basics/rag/*` | [Search & RAG](/docs/capabilities/rag/overview) | Migrating |
| `ai-basics/services/*` | [Platform and Service Matrix](/docs/capabilities/models/platform-service-matrix) and related capability pages | Migrating |
| `ai-basics/provider-and-model-extension` | [Extension](/docs/extending/overview) | Migrating |
| `core-sdk/mcp/*` | [MCP Overview](/docs/capabilities/mcp/overview) | Top-level MCP is now the official main line |
| `guides/*` | [Solutions](/docs/integrations/solutions/overview) | Migrating |
| `agent/coding-agent-*` | [Coding Agent](/docs/products/coding-agent/overview) | Split into a new main line |
| `flowgram/builtin-nodes` | [Built-in Nodes](/docs/products/flowgram/built-in-nodes) | Naming being consolidated |
