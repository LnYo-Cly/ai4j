...
- [Core SDK / Skills](/docs/capabilities/skills/overview)
...
- [MCP](/docs/capabilities/mcp/overview)
...
If you already know what kind of thing you want to do, continue to [Choose Your Path](/docs/getting-started/choose-your-path).

If you want to fully digest the foundation storyline first, the next page to read is [Core SDK / Overview](/docs/capabilities/overview).
