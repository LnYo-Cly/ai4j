...
3. [Core SDK / Tools](/docs/capabilities/tools/overview)
4. [Core SDK / Skills](/docs/capabilities/skills/overview)
5. [Core SDK / MCP](/docs/capabilities/mcp/overview)
6. [Spring Boot / Overview](/docs/integrations/spring-boot/overview)
7. [Extension / Plugin Packages](/docs/extending/plugins/plugin-packages)
8. [Extension / Ask User Plugin](/docs/extending/plugins/ask-user-plugin)
...
If you want to drill further from code structure into package structure next, see [Package Map](/docs/reference/maps/package-map).
