...
- [MCP and ACP](/docs/products/coding-agent/mcp-and-acp)
...
- [Coding Agent Overview](/docs/products/coding-agent/overview)
...
- [Core SDK / Skills Overview](/docs/capabilities/skills/overview)
...
- [Trace and Observability](/docs/agent/observability/trace-observability)
