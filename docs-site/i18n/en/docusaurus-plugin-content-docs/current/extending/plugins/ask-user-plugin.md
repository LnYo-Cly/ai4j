...
If you want to wire `ask-user` together with other third-party plugins, continue to [Plugin Recipes](/docs/extending/plugins/plugin-recipes). It gives the complete configuration shapes for plain Java, Spring Boot, CLI checks, and multi-plugin combinations.
