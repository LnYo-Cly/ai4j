...
For full request headers, server profiles, and the upgrade path, see [Streamable HTTP](/docs/capabilities/mcp/streamable-http).
...
- [MCP Gateway Management](/docs/capabilities/mcp/gateway-management)
- [Tool Exposure Semantics and Security Boundaries](/docs/capabilities/mcp/tool-exposure-semantics)
