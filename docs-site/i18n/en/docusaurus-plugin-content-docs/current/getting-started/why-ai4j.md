...
You do not need to refactor the project into some complete application framework first, nor understand Agent, workflow or complex orchestration up front. Start from [Quickstart for Java](/docs/getting-started/quickstart-java) to verify the model configuration and a single call first.

If the project is already Spring Boot, go through [Quickstart for Spring Boot](/docs/getting-started/quickstart-spring-boot) and let the starter manage configuration and Beans.
...
- [Tool](/docs/capabilities/tools/overview): local function declaration, execution model and safety boundary.
- [Skill](/docs/capabilities/skills/overview): instructions, templates and task assets that the model can read.
- [MCP](/docs/capabilities/mcp/overview): protocol-based integration of external tools and services.
...
AI4J places [Search & RAG](/docs/capabilities/rag/overview) on the main line of the Core SDK, rather than as a demo fully detached from model calls. You can use it progressively as needed:
...
- [Coding Agent](/docs/products/coding-agent/overview)
- [FlowGram](/docs/products/flowgram/overview)
...
| --- | --- |
| Get the first request working | [Quickstart for Java](/docs/getting-started/quickstart-java) |
| Plain Java first | [Quickstart for Java](/docs/getting-started/quickstart-java) |
| Spring Boot integration | [Quickstart for Spring Boot](/docs/getting-started/quickstart-spring-boot) |
| See the full feature map | [Feature Map](/docs/getting-started/feature-map) |
| Understand the Chat call | [Model Access / Chat](/docs/capabilities/models/chat) |
| Let the model call a local tool | [First Tool Call](/docs/getting-started/first-tool-call) |

If you are still unsure which line to take, start with [Feature Map](/docs/getting-started/feature-map).
