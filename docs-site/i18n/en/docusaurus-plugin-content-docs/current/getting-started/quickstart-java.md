...
For the full configuration guide, see [OpenAI-compatible and TroveBox relay platform configuration](/docs/capabilities/models/openai-compatible-and-trovebox).
...
- To integrate with Spring Boot: see [Quickstart for Spring Boot](/docs/getting-started/quickstart-spring-boot)
- To use TroveBox or another relay platform: see [OpenAI-compatible and TroveBox](/docs/capabilities/models/openai-compatible-and-trovebox)
- To understand `Chat` in depth: see [Core SDK / Model Access / Chat](/docs/capabilities/models/chat)
- To let the model call local functions: see [First Tool Call](/docs/getting-started/first-tool-call)
- To see the full capability map: see [Feature Map](/docs/getting-started/feature-map)
