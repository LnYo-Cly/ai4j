...
| --- | --- | --- |
| SDK (`createAgentSession` programmatic API) | `AiService` / `AiServiceRegistry` programmatic factory | [Service Entry and Registry](/docs/capabilities/service-entry) |
| RPC (stdin / stdout JSON-RPC subprocess protocol) | ACP headless host (newline-delimited JSON-RPC) | [ACP Integration](/docs/products/coding-agent/acp-integration) |
| JSON event stream (`--mode json` one-shot event stream → stdout) | **No turnkey equivalent** (building blocks see ① below) | — |
| TUI (interactive terminal) | `ai4j-cli`'s `code` / `tui` host | [CLI / TUI Usage Guide](/docs/products/coding-agent/cli-and-tui) |
| — (no Pi counterpart; ai4j exclusive) | Spring Boot auto-configuration | [Spring Boot Auto Configuration](/docs/integrations/spring-boot/auto-configuration) |
...
→ [Service Entry and Registry](/docs/capabilities/service-entry) · first-chat code see [Quickstart for Java](/docs/getting-started/quickstart-java)
...
→ [Service Entry and Registry](/docs/capabilities/service-entry) · OpenAI-compatible profile see [OpenAI-compatible and TroveBox](/docs/capabilities/models/openai-compatible-and-trovebox)
...
→ [ACP Integration](/docs/products/coding-agent/acp-integration) · boundary with MCP see [MCP and ACP](/docs/products/coding-agent/mcp-and-acp)
...
→ [Trace and Observability](/docs/agent/observability/trace-observability) · resume / replay / audit see [Replay, Recovery & Audit](/docs/agent/observability/replay-recovery-audit)
...
→ [CLI / TUI Usage Guide](/docs/products/coding-agent/cli-and-tui) · themes and four-layer customization see [TUI Customization and Themes](/docs/products/coding-agent/tui-customization)
...
→ [Spring Boot Auto Configuration](/docs/integrations/spring-boot/auto-configuration) · quick wiring see [Quickstart for Spring Boot](/docs/getting-started/quickstart-spring-boot)
...
- [ACP Integration](/docs/products/coding-agent/acp-integration) · [MCP and ACP](/docs/products/coding-agent/mcp-and-acp)
- [Trace and Observability](/docs/agent/observability/trace-observability) · [Replay, Recovery & Audit](/docs/agent/observability/replay-recovery-audit)
- [CLI / TUI Usage Guide](/docs/products/coding-agent/cli-and-tui) · [TUI Customization and Themes](/docs/products/coding-agent/tui-customization)
- [Spring Boot Auto Configuration](/docs/integrations/spring-boot/auto-configuration)
- For the full capability map: [Feature Map](/docs/getting-started/feature-map)
