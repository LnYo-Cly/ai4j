...
- **Tracing** (spans, OTel/Langfuse export): [Trace & Observability](/docs/agent/trace-observability)
- **Session lifecycle** (snapshot/restore): [Session Runtime](/docs/agent/session-runtime)
- **Where replay/recovery tools run**: [Sandbox SPI](/docs/agent/sandbox-spi)
