...
description: "The interception layer of ai4j-agent: ToolInterceptor (block/modify/routeTo sandbox) and PromptInterceptor map to Claude Code's PreToolUse/PostToolUse/UserPromptSubmit, plus observe-only lifecycle hooks, with a hooks facade and CLI configuration."
tags: [how-to]
---
