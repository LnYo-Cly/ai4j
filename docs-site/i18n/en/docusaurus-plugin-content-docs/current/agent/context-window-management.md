...
→ See [Search and RAG overview](/docs/core-sdk/search-and-rag/overview)

## Further reading

- [Memory and Compact Context](/docs/agent/memory-compact-context) — Compaction (the next gate after projection)
- [Memory overview](/docs/core-sdk/memory/overview) — ChatMemory is the input to Projection
- [Compact & Checkpoint](/docs/coding-agent/compact-and-checkpoint) — the compaction pipeline at the Coding Agent layer
- [Agent concept map](/docs/start-here/agent-concepts) — the full Memory → Context Window → Compaction → Checkpoint chain
