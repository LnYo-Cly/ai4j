...
- Need to execute model-generated code: go to [CodeAct Runtime](/docs/agent/runtimes/codeact-runtime)
- Need explicit nodes and state advancement: go to [Workflow StateGraph](/docs/agent/runtimes/workflow-stategraph)
- Need master-delegate delegation: go to [SubAgent and Handoff Policy](/docs/agent/orchestration/subagent-handoff-policy)
- Need team collaboration: go to [Agent Teams](/docs/agent/orchestration/agent-teams)
