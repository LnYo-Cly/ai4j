...
- Just want stronger tool orchestration — usually see [CodeAct Runtime](/docs/agent/runtimes/codeact-runtime) first
- Just delegating one capability to another Agent — usually see [SubAgent and Handoff Policy](/docs/agent/orchestration/subagent-handoff-policy) first
- Need a task board, roles, and a message bus — usually see [Agent Teams](/docs/agent/orchestration/agent-teams)
