...
For more checklist items, see [Production Checklist](/docs/operations/production-checklist).
...
If you are working on local repo tasks, you should start with [Coding Agent](/docs/coding-agent/overview); if you are building a general-purpose business agent, you should start with [Agent](/docs/agent/overview).
