...
[Discovery and Loading](/docs/core-sdk/skills/discovery-and-loading) covers "how SKILL.md is discovered and how the directory is generated".
...
- [Tool Exposure Semantics](/docs/mcp/tool-exposure-semantics) — the relationship between the restricted executor and the tool allowlist
- [Skills overview](/docs/core-sdk/skills/overview) — where skills sit in the architecture
