...
For a full explanation of the online judging layer (`RagJudge` SPI, the `ChatRagJudge` three-dimensional scoring protocol, and how judgments are written into `RagTrace`), see [LLM-as-Judge](/docs/core-sdk/search-and-rag/llm-as-judge).

If you want to see how the online judge is used, refer to [Citations and Trace](/docs/core-sdk/search-and-rag/citations-and-trace).
