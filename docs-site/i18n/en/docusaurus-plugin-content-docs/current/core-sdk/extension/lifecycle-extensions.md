...
:::warning
`LifecycleHookRegistry` and `AgentLifecycleHook` are currently annotated `@Experimental(since = "2.4.3")`; their signatures and behavior may change in later minor versions. Pin the exact version when you depend on them. See [Extension overview - Plugin SPI stability matrix](/docs/core-sdk/extension/overview#32-插件-spi-的稳定性矩阵).
:::
...
3. [Extension SPI Internals](/docs/core-sdk/extension/extension-spi)
