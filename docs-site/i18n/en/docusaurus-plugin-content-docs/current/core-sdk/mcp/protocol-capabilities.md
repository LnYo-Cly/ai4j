...
:::warning
Do not migrate legacy initialization state, session affinity, or capability declarations to the modern endpoint. See [Streamable HTTP](/docs/mcp/streamable-http).
:::
