...
Here `trovebox-low-cost` is a business profile id; `openai` indicates the underlying protocol adaptation. For the full recipe, see [OpenAI-compatible and TroveBox](/docs/start-here/openai-compatible-and-trovebox).
